...
- Language- or framework-specific test idioms (concurrency/race synchronization, mock-library setup, UI test harnesses) when a stack lens covers them — defer to that lens.
